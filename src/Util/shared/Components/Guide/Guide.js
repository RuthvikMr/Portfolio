...
const Guide = (props) => {
    ...
    const iframe = [
        {
            "label":"Read Me",
            "url":"https://github.com/RuthvikMr/FE_interview_preparation/blob/main/README.md"
        },
        {
            "label":"Code Snippet",
            "url":"https://github.com/RuthvikMr/FE_interview_preparation/blob/main/CodeME.md" 
        }
    ]
